...
rcpp_wkt_disjoint_spherical <- function(wktOne, wktTwo) {
    .Call(`_boostgeometry_rcpp_wkt_disjoint_spherical`, wktOne, wktTwo)
}

rcpp_wkt_disjoint_geographic <- function(wktOne, wktTwo) {
    .Call(`_boostgeometry_rcpp_wkt_disjoint_geographic`, wktOne, wktTwo)
}
...
rcpp_wkt_intersects_cartesian <- function(wktOne, wktTwo) {
    .Call(`_boostgeometry_rcpp_wkt_intersects_cartesian`, wktOne, wktTwo)
}

rcpp_wkt_intersects_spherical <- function(wktOne, wktTwo) {
    .Call(`_boostgeometry_rcpp_wkt_intersects_spherical`, wktOne, wktTwo)
}
...
rcpp_bg_join_predicate_cartesian <- function(wktOne, wktTwo, predicate) {
    .Call(`_boostgeometry_rcpp_bg_join_predicate_cartesian`, wktOne, wktTwo, predicate)
}
